 ...
 */
final class Version20220318175905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE teacher DROP image_original_name, DROP image_mime_type, DROP image_dimensions, CHANGE updated_at updated_at DATETIME NOT NULL, CHANGE image_name image_name VARCHAR(255) NOT NULL, CHANGE image_size image_size INT NOT NULL');
    }
