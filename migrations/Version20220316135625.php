 ...
 */
final class Version20220316135625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin DROP email, DROP roles, DROP password, DROP created_at');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE admin ADD email VARCHAR(180) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD roles LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:json)\', ADD password VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
